...
public class Survey extends Main implements java.io.Serializable {
	...
	public void take(String t) throws IOException 
	{
		...
		if(t.equals("Survey")) System.out.println("Please fill out the survey below \n");
		else if(t.equals("Test")) System.out.println("Please fill out the test below \n");
		//Use Display class to give output options for the User Aka audio or console
		this.O.display("Name of the Survey - "+ this.Survey+"\n");	
