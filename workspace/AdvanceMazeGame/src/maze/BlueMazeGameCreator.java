		...
		while ((myLine = reader.readLine()) != null) {
			...
			String[] array = myLine.split(" ");
		        ...
		        if (array[0].equals("room")){
		            ...
		            Room room = new GreenRoom(Integer.parseInt( array[1]));
		            ...
		            maze.addRoom(room);
		            	...
		            	Door theDoor = new BrownDoor(maze.getRoom(Integer.parseInt( array[2])), maze.getRoom(Integer.parseInt( array[3])));
		...
		String[] array2 = myLine2.split(" ");
		        ...
		        if (array2[0].equals("room")){
			        	...
			        	if(array2[2].equals("wall")){	
							room_.get(Integer.parseInt(array2[1])).setSide(Direction.North, new BlueWall());
						}
			        	...
			        	if(array2[3].equals("wall")){	
							room_.get(Integer.parseInt(array2[1])).setSide(Direction.South, new BlueWall());
						}
						...
						if(array2[4].equals("wall")){	
							room_.get(Integer.parseInt(array2[1])).setSide(Direction.East, new BlueWall());
						}
						...
						if(array2[5].equals("wall")){	
							room_.get(Integer.parseInt(array2[1])).setSide(Direction.West, new BlueWall());
						}
